...
| `agent`      | enum    | `dev-lead` / `architect` / `coding` / `data-scientist` / `infrastructure` / `review-lead` / `code-reviewer` / `security-reviewer` / `architecture-reviewer` / `infrastructure-reviewer` / `test-reviewer` / `data-reviewer` |
