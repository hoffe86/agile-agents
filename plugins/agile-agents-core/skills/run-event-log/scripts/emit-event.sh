...
# Enum validation
case "$agent" in
    dev-lead|architect|coding|data-scientist|infrastructure|review|code-reviewer|security-reviewer|architecture-reviewer|infrastructure-reviewer|test-reviewer|data-reviewer) ;;
