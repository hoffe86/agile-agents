...
over 12 specialist agents (1 supervisor + 4 authors + 5 reviewers + a backlog-manager and a bootstrapper) plus
...
**12 agents** (`plugins/agile-agents-core/agents/`) — 1 supervisor + 4 authors + 5 reviewers + backlog-manager + bootstrapper:
