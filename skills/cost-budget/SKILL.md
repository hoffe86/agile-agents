...
| Tier  | Used by                                                                 | Why                                                              |
|-------|-------------------------------------------------------------------------|------------------------------------------------------------------|
| heavy | `architect`, all reviewers (`reviewer-architecture`, `reviewer-code`, `reviewer-security`, `reviewer-tests`, `reviewer-infrastructure`) | Explainability and judgement matter more than speed; a bad architecture or missed security finding is catastrophic. |
| mid   | `coding`, `testing`, `infrastructure`                                   | Day-to-day authoring on a clear spec — cost-quality sweet spot. |
