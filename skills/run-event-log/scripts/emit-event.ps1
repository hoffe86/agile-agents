...
param(
    ...
    [Parameter(Mandatory)] [ValidateSet('dev-lead','architect','coding','testing','infrastructure','review','security-review','architecture-review','infrastructure-review','test-review')] [string] $Agent,
